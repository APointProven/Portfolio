...
const About = () => {
    return (
        <div name="About" className='w-full h-screen bg-secondarycolor'>
            <div className='mx-auto px-8 flex flex-col justify-center h-full'>
                <h1 className='pl-3 sm:text-center sm:pl-0 text-fontsecondary'>About</h1>
                <h2 className='text-buttonfont font-medium text-4xl text-left px-3 pt-3 sm:text-center sm:px-32 lg:px-52'>Hi, I'm Zeke. Nice to meet you. Please take a look around!</h2>
